...
import EnterpriseDeepDive from "./_components/EnterpriseDeepDive";
import SMBDeepDive from "./_components/SMBDeepDive";
import AcademiaDeepDive from "./_components/AcademiaDeepDive";
import PlatformDeepDive from "./_components/PlatformDeepDive";
import APIDeepDive from "./_components/APIDeepDive";
  ...
  return (
    <main className="pb-24">
      <SolutionsLayout mobileNav={<MobileAnchors />} sidebar={<SolutionsSidebar items={NAV} />}>
        ...
        >
          <DeepDive title="See Enterprise detail" summary="Diagrams, live demos, architecture, and enterprise requirements.">
            <EnterpriseDeepDive />
          </DeepDive>
        </SolutionSection>
        ...
        >
          <DeepDive title="See SMB detail" summary="Tool sprawl, live demos, how it works, and growth path.">
            <SMBDeepDive />
          </DeepDive>
        </SolutionSection>
        ...
        >
          <DeepDive title="See Academia detail" summary="Research demos, cross-disciplinary synthesis, and institutional scaling.">
            <AcademiaDeepDive />
          </DeepDive>
        </SolutionSection>
        ...
        >
          <DeepDive title="See Platform detail" summary="Query experience, cognitive modes, thinking styles, role access, and the executive dashboard.">
            <PlatformDeepDive />
          </DeepDive>
        </SolutionSection>
        ...
        >
          <DeepDive title="See API detail" summary="Multi-AI synthesis, service tiers, parameters, use cases, and roadmap.">
            <APIDeepDive />
          </DeepDive>
        </SolutionSection>
        ...
        >
          <DeepDive title="See Extension detail" summary="Free browser extension with multi-AI synthesis, 10 daily queries, and enterprise deployment.">
            <ExtensionDeepDive />
          </DeepDive>
        </SolutionSection>
      </SolutionsLayout>
